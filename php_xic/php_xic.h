...
#define PHP_XIC_EDITION     210115
#define PHP_XIC_REVISION    22102813

#define PHP_XIC_VERSION     XS_TOSTR(PHP_XIC_EDITION) "." XS_TOSTR(PHP_XIC_REVISION)

#define XIC_SO_VERSION		"3.8.1"
