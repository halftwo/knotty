/* $Id: crcmodel.c,v 1.2 2009/02/09 04:46:57 jiagui Exp $ */
/******************************************************************************/
/*                                                                            */
 ...
 */
static ulong widmask(cm_t *p_cm)
{
...
{
	if (p_cm->cm_refout)
		return p_cm->cm_xorout ^ reflect(p_cm->cm_reg, p_cm->cm_width);
	else
		return p_cm->cm_xorout ^ p_cm->cm_reg;
}
