/* $Id: Enforce.h,v 1.4 2014/07/11 07:27:15 gremlin Exp $ */
#ifndef ENFORCE_H_
#define ENFORCE_H_
/////////////////////////////////////////////////////////////////////
...
struct DefaultRaiser
{
	...
	{
		if (message.length())
			throw XERROR_MSG(XEnforceError, std::string(locus) + ": " + message);
		else
			throw XERROR_MSG(XEnforceError, locus);
	}
};
...
#define ENFORCE_LOCUS(exp)	\
	"ENFORCE `" #exp "` failed in " XS_FILE_LINE
